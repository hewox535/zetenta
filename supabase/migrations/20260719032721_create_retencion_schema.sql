...
reemplazando el almacenamiento en localStorage por una base de datos Supabase.
Es una aplicación de un solo inquilino (sin inicio de sesión), por lo que los
datos son compartidos y las políticas permiten acceso anónimo y autenticado.
...
(`lineas`) porque siempre se leen/escriben junto con el comprobante y nunca
...
(AUTO VIDRIOS DUGLARIS, C.A., RIF J-313620220, secuencial 137).
...
- `fecha` se almacena como texto (dd/mm/yyyy) para coincidir con el
  formato que ya maneja la aplicación.
*/
